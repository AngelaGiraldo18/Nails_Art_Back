...
exports.createCita = async (req, res) => {
  try {
    ...
    const { id_usuario, id_manicurista, ubicacion_servicio, fecha_del_servicio, estado } = req.body;
    if (!id_usuario || !id_manicurista || !ubicacion_servicio || !fecha_del_servicio || !estado) {
    ...
    const [insertCita] = await pool.promise().query(
      "INSERT INTO citas (id_usuario, id_manicurista, ubicacion_servicio, duracion_en_horas, fecha_del_servicio, estado) VALUES (?, ?, ?, ?, ?, ?)",
      [id_usuario, id_manicurista, ubicacion_servicio, duracion_en_horas, fecha_del_servicio, estado]
    );
