...
//catalogo
router.post('/catalogo/:id_usuario', upload.single('imagen'), Manicurista.agregarImagenCatalogo);
router.get('/catalogo/usuario/:id_usuario', Manicurista.obtenerImagenesPorUsuario);
